...
class SpotifyAccountPlaylistsFragment : BaseMvRxFragment() {
    ...
    override fun onCreateView(
        ...
        FragmentSpotifyAccountPlaylistsBinding.inflate(inflater, container, false)
            .apply {
                spotifyAccountPlaylistsRecyclerView.layoutManager =
                    layoutManagerFor(resources.configuration.orientation)
                binding = this
            }
            .root
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        binding.spotifyAccountPlaylistsRecyclerView.layoutManager =
            layoutManagerFor(newConfig.orientation)
    }
