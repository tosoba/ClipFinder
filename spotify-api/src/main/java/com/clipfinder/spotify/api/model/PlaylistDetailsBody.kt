 ...
 * @param collaborative If true , the playlist will become collaborative and other users will be
 * able to modify the playlist in their Spotify client. Note: You can only set collaborative to true
 * on non-public playlists.
 * @param description Value for playlist description as displayed in Spotify Clients and in the Web
 * API.
 */
data class PlaylistDetailsBody(
    ...
    @Json(name = "collaborative") val collaborative: Boolean? = null,
