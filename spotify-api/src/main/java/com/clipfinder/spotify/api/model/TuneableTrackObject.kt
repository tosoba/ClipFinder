 ...
 * being the most popular. The popularity is calculated by algorithm and is based, in the most part,
 * on the total number of plays the track has had and how recent those plays are. Note: When
 * applying track relinking via the market parameter, it is expected to find relinked tracks with
 * popularities that do not match min_*, max_*and target_* popularities. These relinked tracks are
 * accurate replacements for unplayable tracks with the expected popularity scores. Original,
...
data class TuneableTrackObject(
    ...
    @Json(name = "popularity") val popularity: java.math.BigDecimal? = null,
    /* Speechiness detects the presence of spoken words in a track. The more exclusively speech-like the recording (e.g. talk show, audio book, poetry), the closer to 1.0 the attribute value. Values above 0.66 describe tracks that are probably made entirely of spoken words. Values between 0.33 and 0.66 describe tracks that may contain both music and speech, either in sections or layered, including such cases as rap music. Values below 0.33 most likely represent music and other non-speech-like tracks. */
    @Json(name = "speechiness") val speechiness: java.math.BigDecimal? = null,
    ...
    @Json(name = "valence") val valence: java.math.BigDecimal? = null
)
