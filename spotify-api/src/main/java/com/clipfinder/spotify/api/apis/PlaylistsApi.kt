...
interface PlaylistsApi {
    ...
    fun endpointGetPlaylist(@Header("Authorization") authorization: String, @Path("playlist_id") playlistId: String, @Query("fields") fields: String? = null, @Query("market") market: String? = null, @Query("additional_types") additionalTypes: String? = null): Call<PlaylistObject>
    ...
    fun endpointGetPlaylistCover(@Header("Authorization") authorization: String, @Path("playlist_id") playlistId: String): Call<List<ImageObject>>
    ...
    fun endpointUploadCustomPlaylistCover(@Header("Authorization") authorization: String, @Header("Content-Type") contentMinusType: String, @Path("playlist_id") playlistId: String): Call<Unit>
