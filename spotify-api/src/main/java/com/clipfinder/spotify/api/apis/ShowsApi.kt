...
import com.clipfinder.spotify.api.models.InlineResponse2009
...
interface ShowsApi {
    ...
    fun endpointGetAShowsEpisodes(@Header("Authorization") authorization: String, @Path("id") id: String, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null, @Query("market") market: String? = null): Call<InlineResponse2009>
