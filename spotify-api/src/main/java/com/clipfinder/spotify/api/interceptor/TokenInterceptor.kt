...
class TokenInterceptor(private val isPrivate: Boolean, private val holder: ISpotifyTokensHolder) :
    Interceptor {
    private val accessToken: String
        get() =
            (if (isPrivate) holder.privateAccessToken else holder.publicAccessToken) ?: "NO_TOKEN"
