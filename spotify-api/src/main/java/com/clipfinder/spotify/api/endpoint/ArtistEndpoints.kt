...
interface ArtistEndpoints {
     ...
     */
    @GET("artists/{id}")
    fun getAnArtist(@Header("Authorization") authorization: String? = null, @Path("id") id: String): Single<NetworkResponse<ArtistObject, ErrorResponse>>
    ...
    fun getAnArtistsAlbums(@Header("Authorization") authorization: String? = null, @Path("id") id: String, @Query("include_groups") includeGroups: String? = null, @Query("market") market: String? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<SimplifiedAlbumsPagingObject, ErrorResponse>>
    ...
    fun getAnArtistsRelatedArtists(@Header("Authorization") authorization: String? = null, @Path("id") id: String): Single<NetworkResponse<ArtistsObject, ErrorResponse>>
    ...
    fun getAnArtistsTopTracks(@Header("Authorization") authorization: String? = null, @Path("id") id: String, @Query("market") market: String): Single<NetworkResponse<TracksObject, ErrorResponse>>
