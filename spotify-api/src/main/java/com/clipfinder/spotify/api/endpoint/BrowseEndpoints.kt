...
interface BrowseEndpoints {
    ...
    fun getACategoriesPlaylists(@Header("Authorization") authorization: String? = null, @Path("category_id") categoryId: String, @Query("country") country: String? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<SimplifiedPlaylists, ErrorResponse>>
    ...
    fun getACategory(@Header("Authorization") authorization: String? = null, @Path("category_id") categoryId: String, @Query("country") country: String? = null, @Query("locale") locale: String? = null): Single<NetworkResponse<CategoryObject, ErrorResponse>>
    ...
    fun getCategories(@Header("Authorization") authorization: String? = null, @Query("country") country: String? = null, @Query("locale") locale: String? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<CategoriesObject, ErrorResponse>>
    ...
    fun getFeaturedPlaylists(@Header("Authorization") authorization: String? = null, @Query("country") country: String? = null, @Query("locale") locale: String? = null, @Query("timestamp") timestamp: Int? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<FeaturedPlaylistObject, ErrorResponse>>
    ...
    fun getNewReleases(@Header("Authorization") authorization: String? = null, @Query("country") country: String? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<NewReleases, ErrorResponse>>
    ...
    fun getRecommendationGenres(@Header("Authorization") authorization: String? = null): Single<NetworkResponse<GenreSeedsObject, ErrorResponse>>
