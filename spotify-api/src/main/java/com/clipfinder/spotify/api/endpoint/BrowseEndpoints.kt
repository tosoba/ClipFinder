...
interface BrowseEndpoints {
    ...
    fun endpointGetACategoriesPlaylists(@Header("Authorization") authorization: String? = null, @Path("category_id") categoryId: String, @Query("country") country: String? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<SimplifiedPlaylists, ErrorResponse>>
    ...
    fun endpointGetACategory(@Header("Authorization") authorization: String? = null, @Path("category_id") categoryId: String, @Query("country") country: String? = null, @Query("locale") locale: String? = null): Single<NetworkResponse<CategoryObject, ErrorResponse>>
    ...
    fun endpointGetCategories(@Header("Authorization") authorization: String? = null, @Query("country") country: String? = null, @Query("locale") locale: String? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<CategoriesObject, ErrorResponse>>
    ...
    fun endpointGetFeaturedPlaylists(@Header("Authorization") authorization: String? = null, @Query("country") country: String? = null, @Query("locale") locale: String? = null, @Query("timestamp") timestamp: Int? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<FeaturedPlaylistObject, ErrorResponse>>
    ...
    fun endpointGetNewReleases(@Header("Authorization") authorization: String? = null, @Query("country") country: String? = null, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): Single<NetworkResponse<NewReleases, ErrorResponse>>
    ...
    fun endpointGetRecommendationGenres(@Header("Authorization") authorization: String? = null): Single<NetworkResponse<GenreSeedsObject, ErrorResponse>>
     ...
     */
    @GET("recommendations")
    fun endpointGetRecommendations(@Header("Authorization") authorization: String? = null, @Query("seed_artists") seedArtists: String, @Query("seed_genres") seedGenres: String, @Query("seed_tracks") seedTracks: String, @Query("limit") limit: Int? = null, @Query("market") market: String? = null, @Query("min_*") minStar: java.math.BigDecimal? = null, @Query("max_*") maxStar: java.math.BigDecimal? = null, @Query("target_*") targetStar: java.math.BigDecimal? = null): Single<NetworkResponse<RecommendationsResponseObject, ErrorResponse>>
