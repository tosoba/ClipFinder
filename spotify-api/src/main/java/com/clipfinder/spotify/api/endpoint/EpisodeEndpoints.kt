...
interface EpisodeEndpoints {
     ...
     */
    @GET("episodes/{id}")
    fun getAnEpisode(@Header("Authorization") authorization: String? = null, @Path("id") id: String, @Query("market") market: String? = null): Single<NetworkResponse<EpisodeObject, ErrorResponse>>
