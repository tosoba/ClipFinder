...
class CategoryViewModel(
    ...
    companion object : MvRxViewModelFactory<CategoryViewModel, CategoryViewState> {
        override fun create(
                viewModelContext: ViewModelContext, state: CategoryViewState
        ): CategoryViewModel {
            ...
            return CategoryViewModel(state,
                    getPlaylistsForCategory, insertCategory,
                    deleteCategory, isCategorySaved)
        }
    }
}