...
abstract class ItemListFragment<S> : BaseMvRxFragment() {
    ...
    override fun onCreateView(
        ...
        inflater.inflate(R.layout.fragment_item_list, container, false).also {
    ...
    @Parcelize
    class Args(val spanCountPortrait: Int, val spanCountLandscape: Int, val itemSpacingDp: Int) :
        Parcelable
}
