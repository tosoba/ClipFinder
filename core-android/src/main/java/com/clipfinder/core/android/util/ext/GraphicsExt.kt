                ...
                GradientDrawable(
                        ...
                        intArrayOf(
                            it.vibrantSwatch?.rgb
                                ?: it.lightVibrantSwatch?.rgb ?: it.lightMutedSwatch?.rgb
                                    ?: it.mutedSwatch?.rgb ?: Color.TRANSPARENT,
                            it.dominantSwatch?.rgb
                                ?: it.darkVibrantSwatch?.rgb ?: it.darkMutedSwatch?.rgb
                                    ?: it.mutedSwatch?.rgb ?: Color.TRANSPARENT
                        )
                    )
...
val Palette.dominantColor: Int
    get() =
        vibrantSwatch?.rgb
            ?: dominantSwatch?.rgb ?: lightVibrantSwatch?.rgb ?: darkVibrantSwatch?.rgb
                ?: Color.WHITE
