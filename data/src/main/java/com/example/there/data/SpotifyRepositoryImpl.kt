...
class SpotifyRepositoryImpl(api: SpotifyApi,
                            ...
                            accessTokenMapper: Mapper<AccessTokenData, String>) : SpotifyRepository {
    ...
    override fun getAccessToken(clientId: String, clientSecret: String): Observable<String> = remoteSpotifyDataStore.getAccessToken(clientId, clientSecret)
