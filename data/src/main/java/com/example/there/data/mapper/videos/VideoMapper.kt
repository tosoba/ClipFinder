...
import com.example.there.data.util.fallbackURL
...
class VideoMapper @Inject constructor() : Mapper<VideoData, VideoEntity>() {
    override fun mapFrom(from: VideoData): VideoEntity = VideoEntity(
            ...
            thumbnailUrl = from.snippet.thumbnails.medium?.url ?: from.snippet.thumbnails.high?.url
            ?: from.snippet.thumbnails.default?.url ?: from.snippet.thumbnails.fallbackURL,
