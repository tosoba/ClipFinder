...
) : ISpotifyCategory, Parcelable, NamedImageListItem {

    constructor(
        other: ISpotifyCategory
    ) : this(other.id, other.name, other.icons.map(::Image), other.href)
...
fun Category.clickableListItem(itemClicked: () -> Unit): ImageListItemBindingModel_ =
