...
class SpotifyTrackFragment : BaseMvRxFragment(), ISpotifyTrackFragment {
    ...
    override fun onCreateView(
        ...
        inflater.inflate(R.layout.fragment_spotify_track, container, false).apply {
    ...
    companion object {
        ...
        private val audioFeaturesChartLabels: List<String> =
            ISpotifyAudioFeatures::class.decimalProps.map(KCallable<BigDecimal>::name)
    }
}
